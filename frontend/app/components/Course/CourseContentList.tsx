...
const CourseContentList: FC<Props> = (props) => {
  ...
  // Use an object to find unique video sections
  const videoSectionsObj: { [key: string]: boolean } = {};
  props.data?.forEach((item: any) => {
    videoSectionsObj[item.videoSection] = true;
  });

  const videoSections: string[] = Object.keys(videoSectionsObj);
