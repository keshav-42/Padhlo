  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Padhlo.?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Padhlo., the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Padhlo., I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Padhlo. &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Padhlo., we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Padhlo. is more than just a community &ndash; we&apos;re a family.
          ...
          <br />
          <br />
          With Padhlo. by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Padhlo. family today and
        ...
        <br />
        <span className="text-[22px]">Harshit Shrivastav </span>

        <h5 className="text-[18px] font-Poppins">Founder and CEO of Padhlo.</h5>
        <br />
        <br />
        <br />
      </div>
