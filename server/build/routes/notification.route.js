...
notificationRoute.put("/update-notification/:id", notification_controller_1.updateNotification, auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), notification_controller_1.updateNotification);
